package com.jorgeazzufranco.personas.Entidades;
...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public boolean add(Persona p){
        ...
        Toast.makeText(context,"Insertado con exito xd",Toast.LENGTH_SHORT).show();
        return true;
    ...
    public boolean editUser(Persona p){
        ...
        Toast.makeText(context,"Usuario Actualizado con exito xdxd",Toast.LENGTH_SHORT).show();
        return true;
    }
    public boolean deleteUser(String dui){
        String[] parametros ={dui};
        db.delete(TABLA_USUARIO,CAMPO_ID+"=?",parametros);
        Toast.makeText(context,"Usuario Eliminado con exito xdxdxd",Toast.LENGTH_SHORT).show();
        return true;
    }
